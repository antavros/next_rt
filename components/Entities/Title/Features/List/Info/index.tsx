...
export const DetailsList: React.FC<Details> = ({ details }) => {
  return (
    <section className="details_list">
      ...
      {details?.premiereRussia?.length > 1 ||
      details?.premiereUSA?.length > 1 ||
      details?.premiereWorld?.length > 1 ||
      details?.premiereBluray?.length > 1 ? (
        <article>
          <h4>Премьера</h4>
          <div className="data">
            <ul>
          ...
          <div className="data">
            <ul>
              {details?.feesRussia && (
                <li>
                  <h5>Россия</h5>
                  <h6>{details?.feesRussia}</h6>
                </li>
              )}
              {details?.feesUSA && (
                <li>
                  <h5>США</h5>
                  <h6>{details?.feesUSA}</h6>
                </li>
              )}
              {details?.feesWorld && (
                <li>
                  <h5>Мир</h5>
                  <h6>{details?.feesWorld}</h6>
                </li>
              )}
            </ul>
          </div>
          ...
          <div className="data">
            <ul>
              {details?.audience?.map((audience: any, index: any) => (
                <li key={index}>
                  <h6>{audience?.country}</h6>
                  <h6>{audience?.count}</h6>
                </li>
              ))}
            </ul>
          </div>
